...
export const generateHotelSchema = () => ({
  ...
  alternateName: "Paradiso Madonie Hotel",
  description: "Hotel 3 stelle nel cuore del Parco delle Madonie a Castelbuono, Sicilia. A 23km da Cefalù, tra mare e montagna. Camere confortevoli, WiFi gratuito, ristorante tipico siciliano.",
